...
/**
 * SiteSearch related configuration of an Elastic Stack version
 */
@Schema(description = "SiteSearch related configuration of an Elastic Stack version")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-03-10T16:33:30.970+05:30[Asia/Kolkata]")
public class StackVersionSiteSearchConfig {
  ...
  public StackVersionSiteSearchConfig version(String version) {
   ...
   * @return version
  **/
  @Schema(description = "Version of SiteSearch")
  ...
  public StackVersionSiteSearchConfig dockerImage(String dockerImage) {
   ...
   * @return dockerImage
  **/
  @Schema(required = true, description = "Docker image for the SiteSearch")
  ...
  public StackVersionSiteSearchConfig blacklist(List<String> blacklist) {
    this.blacklist = blacklist;
    return this;
  }

  public StackVersionSiteSearchConfig addBlacklistItem(String blacklistItem) {
  ...
  **/
  ...
  public StackVersionSiteSearchConfig settings(Object settings) {
  ...
  **/
  ...
  public StackVersionSiteSearchConfig capacityConstraints(StackVersionInstanceCapacityConstraint capacityConstraints) {
  ...
  **/
  ...
  public StackVersionSiteSearchConfig compatibleNodeTypes(List<String> compatibleNodeTypes) {
    this.compatibleNodeTypes = compatibleNodeTypes;
    return this;
  }

  public StackVersionSiteSearchConfig addCompatibleNodeTypesItem(String compatibleNodeTypesItem) {
  ...
  **/
  ...
  public StackVersionSiteSearchConfig nodeTypes(List<StackVersionNodeType> nodeTypes) {
    this.nodeTypes = nodeTypes;
    return this;
  }

  public StackVersionSiteSearchConfig addNodeTypesItem(StackVersionNodeType nodeTypesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StackVersionSiteSearchConfig stackVersionSiteSearchConfig = (StackVersionSiteSearchConfig) o;
    return Objects.equals(this.version, stackVersionSiteSearchConfig.version) &&
        Objects.equals(this.dockerImage, stackVersionSiteSearchConfig.dockerImage) &&
        Objects.equals(this.blacklist, stackVersionSiteSearchConfig.blacklist) &&
        Objects.equals(this.settings, stackVersionSiteSearchConfig.settings) &&
        Objects.equals(this.capacityConstraints, stackVersionSiteSearchConfig.capacityConstraints) &&
        Objects.equals(this.compatibleNodeTypes, stackVersionSiteSearchConfig.compatibleNodeTypes) &&
        Objects.equals(this.nodeTypes, stackVersionSiteSearchConfig.nodeTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StackVersionSiteSearchConfig {\n");
