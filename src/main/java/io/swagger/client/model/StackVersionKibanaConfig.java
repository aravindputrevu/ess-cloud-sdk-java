 ...
 */
@Schema(description = "The Kibana configuration for an Elastic Stack version.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-03-10T16:33:30.970+05:30[Asia/Kolkata]")
public class StackVersionKibanaConfig {
  ...
  public StackVersionKibanaConfig version(String version) {
   ...
   * @return version
  **/
  @Schema(description = "Version of Kibana")
  ...
  public StackVersionKibanaConfig dockerImage(String dockerImage) {
   ...
   * @return dockerImage
  **/
  @Schema(required = true, description = "Docker image for the kibana")
  ...
  public StackVersionKibanaConfig blacklist(List<String> blacklist) {
    this.blacklist = blacklist;
    return this;
  }

  public StackVersionKibanaConfig addBlacklistItem(String blacklistItem) {
  ...
  **/
  ...
  public StackVersionKibanaConfig settings(Object settings) {
  ...
  **/
  ...
  public StackVersionKibanaConfig capacityConstraints(StackVersionInstanceCapacityConstraint capacityConstraints) {
  ...
  **/
  ...
  public StackVersionKibanaConfig compatibleNodeTypes(List<String> compatibleNodeTypes) {
    this.compatibleNodeTypes = compatibleNodeTypes;
    return this;
  }

  public StackVersionKibanaConfig addCompatibleNodeTypesItem(String compatibleNodeTypesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StackVersionKibanaConfig stackVersionKibanaConfig = (StackVersionKibanaConfig) o;
    return Objects.equals(this.version, stackVersionKibanaConfig.version) &&
        Objects.equals(this.dockerImage, stackVersionKibanaConfig.dockerImage) &&
        Objects.equals(this.blacklist, stackVersionKibanaConfig.blacklist) &&
        Objects.equals(this.settings, stackVersionKibanaConfig.settings) &&
        Objects.equals(this.capacityConstraints, stackVersionKibanaConfig.capacityConstraints) &&
        Objects.equals(this.compatibleNodeTypes, stackVersionKibanaConfig.compatibleNodeTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class StackVersionKibanaConfig {\n");
