...
import io.swagger.client.model.ApmSystemSettings;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * The configuration options for the APM Server.
 */
@Schema(description = "The configuration options for the APM Server.")
...
public class ApmConfiguration {
  ...
  private ApmSystemSettings systemSettings = null;
  ...
  public ApmConfiguration version(String version) {
   ...
   * @return version
  **/
  @Schema(description = "The version of the Apm cluster (must be one of the ECE supported versions, and won't work unless it matches the APM version. Leave blank to auto-detect version.)")
  ...
  public ApmConfiguration dockerImage(String dockerImage) {
  ...
  **/
  ...
  public ApmConfiguration systemSettings(ApmSystemSettings systemSettings) {
  ...
  **/
  @Schema(description = "")
  public ApmSystemSettings getSystemSettings() {
    return systemSettings;
  }

  public void setSystemSettings(ApmSystemSettings systemSettings) {
    this.systemSettings = systemSettings;
  }

  public ApmConfiguration userSettingsJson(Object userSettingsJson) {
  ...
  **/
  ...
  public ApmConfiguration userSettingsYaml(String userSettingsYaml) {
  ...
  **/
  ...
  public ApmConfiguration userSettingsOverrideJson(Object userSettingsOverrideJson) {
  ...
  **/
  ...
  public ApmConfiguration userSettingsOverrideYaml(String userSettingsOverrideYaml) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApmConfiguration apmConfiguration = (ApmConfiguration) o;
    return Objects.equals(this.version, apmConfiguration.version) &&
        Objects.equals(this.dockerImage, apmConfiguration.dockerImage) &&
        Objects.equals(this.systemSettings, apmConfiguration.systemSettings) &&
        Objects.equals(this.userSettingsJson, apmConfiguration.userSettingsJson) &&
        Objects.equals(this.userSettingsYaml, apmConfiguration.userSettingsYaml) &&
        Objects.equals(this.userSettingsOverrideJson, apmConfiguration.userSettingsOverrideJson) &&
        Objects.equals(this.userSettingsOverrideYaml, apmConfiguration.userSettingsOverrideYaml);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApmConfiguration {\n");
