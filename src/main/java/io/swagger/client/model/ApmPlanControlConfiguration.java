 ...
 */
@Schema(description = "The plan control configuration options for the APM Server.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-03-10T16:33:30.970+05:30[Asia/Kolkata]")
public class ApmPlanControlConfiguration {
  ...
  public ApmPlanControlConfiguration timeout(Long timeout) {
  ...
  **/
  ...
  public ApmPlanControlConfiguration calmWaitTime(Long calmWaitTime) {
  ...
  **/
  ...
  public ApmPlanControlConfiguration moveInstances(List<InstanceMoveRequest> moveInstances) {
    this.moveInstances = moveInstances;
    return this;
  }

  public ApmPlanControlConfiguration addMoveInstancesItem(InstanceMoveRequest moveInstancesItem) {
  ...
  **/
  ...
  public ApmPlanControlConfiguration moveAllocators(List<AllocatorMoveRequest> moveAllocators) {
    this.moveAllocators = moveAllocators;
    return this;
  }

  public ApmPlanControlConfiguration addMoveAllocatorsItem(AllocatorMoveRequest moveAllocatorsItem) {
  ...
  **/
  ...
  public ApmPlanControlConfiguration reallocateInstances(Boolean reallocateInstances) {
  ...
  **/
  ...
  public ApmPlanControlConfiguration preferredAllocators(List<String> preferredAllocators) {
    this.preferredAllocators = preferredAllocators;
    return this;
  }

  public ApmPlanControlConfiguration addPreferredAllocatorsItem(String preferredAllocatorsItem) {
  ...
  **/
  ...
  public ApmPlanControlConfiguration extendedMaintenance(Boolean extendedMaintenance) {
  ...
  **/
  ...
  public ApmPlanControlConfiguration clusterReboot(ClusterRebootEnum clusterReboot) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApmPlanControlConfiguration apmPlanControlConfiguration = (ApmPlanControlConfiguration) o;
    return Objects.equals(this.timeout, apmPlanControlConfiguration.timeout) &&
        Objects.equals(this.calmWaitTime, apmPlanControlConfiguration.calmWaitTime) &&
        Objects.equals(this.moveInstances, apmPlanControlConfiguration.moveInstances) &&
        Objects.equals(this.moveAllocators, apmPlanControlConfiguration.moveAllocators) &&
        Objects.equals(this.reallocateInstances, apmPlanControlConfiguration.reallocateInstances) &&
        Objects.equals(this.preferredAllocators, apmPlanControlConfiguration.preferredAllocators) &&
        Objects.equals(this.extendedMaintenance, apmPlanControlConfiguration.extendedMaintenance) &&
        Objects.equals(this.clusterReboot, apmPlanControlConfiguration.clusterReboot);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApmPlanControlConfiguration {\n");
