 ...
 */
@Schema(description = "Information about the App Search Server plan.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-03-10T16:33:30.970+05:30[Asia/Kolkata]")
public class AppSearchPlanInfo {
  ...
  public AppSearchPlanInfo planAttemptId(String planAttemptId) {
  ...
  **/
  ...
  public AppSearchPlanInfo planAttemptName(String planAttemptName) {
  ...
  **/
  ...
  public AppSearchPlanInfo healthy(Boolean healthy) {
  ...
  **/
  ...
  public AppSearchPlanInfo attemptStartTime(OffsetDateTime attemptStartTime) {
  ...
  **/
  @Schema(required = true, description = "When this plan attempt (ie to apply the plan to the App Search) started (ISO format in UTC)")
  ...
  public AppSearchPlanInfo attemptEndTime(OffsetDateTime attemptEndTime) {
  ...
  **/
  ...
  public AppSearchPlanInfo planEndTime(OffsetDateTime planEndTime) {
  ...
  **/
  ...
  public AppSearchPlanInfo plan(AppSearchPlan plan) {
    this.plan = plan;
    return this;
  }
  ...
  **/
  ...
  public AppSearchPlanInfo planAttemptLog(List<ClusterPlanStepInfo> planAttemptLog) {
    this.planAttemptLog = planAttemptLog;
    return this;
  }

  public AppSearchPlanInfo addPlanAttemptLogItem(ClusterPlanStepInfo planAttemptLogItem) {
  ...
  **/
  ...
  public AppSearchPlanInfo source(ChangeSourceInfo source) {
    this.source = source;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AppSearchPlanInfo appSearchPlanInfo = (AppSearchPlanInfo) o;
    return Objects.equals(this.planAttemptId, appSearchPlanInfo.planAttemptId) &&
        Objects.equals(this.planAttemptName, appSearchPlanInfo.planAttemptName) &&
        Objects.equals(this.healthy, appSearchPlanInfo.healthy) &&
        Objects.equals(this.attemptStartTime, appSearchPlanInfo.attemptStartTime) &&
        Objects.equals(this.attemptEndTime, appSearchPlanInfo.attemptEndTime) &&
        Objects.equals(this.planEndTime, appSearchPlanInfo.planEndTime) &&
        Objects.equals(this.plan, appSearchPlanInfo.plan) &&
        Objects.equals(this.planAttemptLog, appSearchPlanInfo.planAttemptLog) &&
        Objects.equals(this.source, appSearchPlanInfo.source);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppSearchPlanInfo {\n");
