...
public class AppSearchPlanControlConfiguration {
  ...
  public AppSearchPlanControlConfiguration timeout(Long timeout) {
  ...
  **/
  ...
  public AppSearchPlanControlConfiguration calmWaitTime(Long calmWaitTime) {
  ...
  **/
  ...
  public AppSearchPlanControlConfiguration moveInstances(List<InstanceMoveRequest> moveInstances) {
    this.moveInstances = moveInstances;
    return this;
  }

  public AppSearchPlanControlConfiguration addMoveInstancesItem(InstanceMoveRequest moveInstancesItem) {
  ...
  **/
  ...
  public AppSearchPlanControlConfiguration moveAllocators(List<AllocatorMoveRequest> moveAllocators) {
    this.moveAllocators = moveAllocators;
    return this;
  }

  public AppSearchPlanControlConfiguration addMoveAllocatorsItem(AllocatorMoveRequest moveAllocatorsItem) {
  ...
  **/
  ...
  public AppSearchPlanControlConfiguration reallocateInstances(Boolean reallocateInstances) {
  ...
  **/
  ...
  public AppSearchPlanControlConfiguration preferredAllocators(List<String> preferredAllocators) {
    this.preferredAllocators = preferredAllocators;
    return this;
  }

  public AppSearchPlanControlConfiguration addPreferredAllocatorsItem(String preferredAllocatorsItem) {
  ...
  **/
  ...
  public AppSearchPlanControlConfiguration extendedMaintenance(Boolean extendedMaintenance) {
  ...
  **/
  ...
  public AppSearchPlanControlConfiguration clusterReboot(ClusterRebootEnum clusterReboot) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AppSearchPlanControlConfiguration appSearchPlanControlConfiguration = (AppSearchPlanControlConfiguration) o;
    return Objects.equals(this.timeout, appSearchPlanControlConfiguration.timeout) &&
        Objects.equals(this.calmWaitTime, appSearchPlanControlConfiguration.calmWaitTime) &&
        Objects.equals(this.moveInstances, appSearchPlanControlConfiguration.moveInstances) &&
        Objects.equals(this.moveAllocators, appSearchPlanControlConfiguration.moveAllocators) &&
        Objects.equals(this.reallocateInstances, appSearchPlanControlConfiguration.reallocateInstances) &&
        Objects.equals(this.preferredAllocators, appSearchPlanControlConfiguration.preferredAllocators) &&
        Objects.equals(this.extendedMaintenance, appSearchPlanControlConfiguration.extendedMaintenance) &&
        Objects.equals(this.clusterReboot, appSearchPlanControlConfiguration.clusterReboot);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppSearchPlanControlConfiguration {\n");
